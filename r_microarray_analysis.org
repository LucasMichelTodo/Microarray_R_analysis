...
:PROPERTIES:
:header-args:R: :session R1 :tangle microarray_analysis.R :comments none :results none :colnames yes :eval never
:END:
...
:PROPERTIES:
:header-args:R: :session R1 :tangle microarray_analysis.R :results none :eval never
:END:
